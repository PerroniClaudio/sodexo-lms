...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('video_exercises')) {
        ...
        if (! Schema::hasTable('video_exercise_materials')) {
        ...
        if (! Schema::hasTable('video_exercise_questions')) {
        ...
        if (! Schema::hasTable('video_exercise_submissions')) {
        ...
        if (! Schema::hasTable('video_exercise_answers')) {
