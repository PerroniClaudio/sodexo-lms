...
class SodexoJobDataSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            ['name' => 'RLS', 'description' => 'Rappresentante dei Lavoratori per la Sicurezza'],
        ...
        $this->command->info('✓ Categorie, livelli e ruoli lavorativi creati correttamente');
