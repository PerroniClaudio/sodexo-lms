...
Route::middleware(['auth', 'role:admin|superadmin'])->group(function () {
    Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        Route::get('/courses/{course}/classes/search-tutors', [CourseClassController::class, 'searchTutors'])->name('courses.classes.search-tutors');
        ...
        Route::post('/courses/{course}/classes/{courseClass}/tutors', [CourseClassController::class, 'storeTutors'])->name('courses.classes.tutors.store');
        Route::delete('/courses/{course}/classes/{courseClass}/tutors', [CourseClassController::class, 'destroyTutors'])->name('courses.classes.tutors.destroy-many');
        Route::delete('/courses/{course}/classes/{courseClass}/tutors/{assignment}', [CourseClassController::class, 'destroyTutor'])->name('courses.classes.tutors.destroy');
        ...
        Route::group(['prefix' => 'api', 'as' => 'api.'], function () {
            ...
            Route::get('/courses/{course}/faculty-members', [CourseFacultyMemberController::class, 'indexApi'])->name('courses.faculty-members.index');
            Route::get('/courses/{course}/faculty-members/search-users', [CourseFacultyMemberController::class, 'searchUsersApi'])->name('courses.faculty-members.search-users');
            Route::post('/courses/{course}/faculty-members', [CourseFacultyMemberController::class, 'storeApi'])->name('courses.faculty-members.store');
            Route::put('/courses/{course}/faculty-members/{facultyMember}', [CourseFacultyMemberController::class, 'updateApi'])->name('courses.faculty-members.update');
            Route::post('/courses/{course}/faculty-members/{facultyMember}/restore', [CourseFacultyMemberController::class, 'restoreApi'])->name('courses.faculty-members.restore');
            Route::delete('/courses/{course}/faculty-members/{facultyMember}', [CourseFacultyMemberController::class, 'destroyApi'])->name('courses.faculty-members.destroy');
