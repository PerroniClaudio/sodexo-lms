...
test('login view renders lucide icons and daisyui fieldset markup for credentials', function () {
    ...
    $response
        ...
        ->assertSee('class="swap-off h-4 w-4"', false)
        ->assertSee('class="swap-on h-4 w-4"', false)
