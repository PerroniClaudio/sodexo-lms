...
class HomepageCustomizationController extends Controller
{
    public function index(): View
    {
        ...
        return view('admin.homepage.index', [
            'logoPath' => $logoPath,
            'logoUrl' => $logoPath ? Storage::temporaryUrl($logoPath, now()->addHour()) : null,
            'heroBackgroundImagePath' => $heroBackgroundImagePath,
            'heroBackgroundImageUrl' => $heroBackgroundImagePath ? Storage::temporaryUrl($heroBackgroundImagePath, now()->addHour()) : null,
            ...
            'servicesVisualImageUrl' => $servicesVisualImagePath ? Storage::temporaryUrl($servicesVisualImagePath, now()->addHour()) : null,
            ...
            'aboutVisualImageUrl' => $aboutVisualImagePath ? Storage::temporaryUrl($aboutVisualImagePath, now()->addHour()) : null,
