...
<x-layouts.app>
    @php
        ...
        $heroBackgroundImageUrl = $heroBackgroundImagePath ? \Illuminate\Support\Facades\Storage::temporaryUrl($heroBackgroundImagePath, now()->addHour()) : null;
        $servicesVisualImagePath = \App\Models\HomepageSetting::value('services_visual_image_path');
        $servicesVisualImageUrl = $servicesVisualImagePath ? \Illuminate\Support\Facades\Storage::temporaryUrl($servicesVisualImagePath, now()->addHour()) : null;
        $aboutVisualImagePath = \App\Models\HomepageSetting::value('about_visual_image_path');
        $aboutVisualImageUrl = $aboutVisualImagePath ? \Illuminate\Support\Facades\Storage::temporaryUrl($aboutVisualImagePath, now()->addHour()) : null;
    @endphp
