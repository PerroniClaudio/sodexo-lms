<x-layouts.admin>
    <div class="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 sm:p-6 lg:p-8">
        <x-page-header :title="__('Nuovo livello di inquadramento')" />

        <div class="card border border-base-300 bg-base-100 shadow-sm">
            <div class="card-body gap-6">
                <form method="POST" action="{{ route('admin.job-levels.store') }}" class="flex flex-col gap-6">
                    @csrf
                    ...
                    <div class="flex justify-end gap-3">
                        <a href="{{ route('admin.job-levels.index') }}" class="btn btn-ghost">
                            {{ __('Cancel') }}
                        </a>
