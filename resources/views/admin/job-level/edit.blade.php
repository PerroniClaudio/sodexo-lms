                ...
                @if($level->trashed())
                    <form method="POST" action="{{ route('admin.job-levels.restore', $level->id) }}" class="inline">
                        ...
                        <button type="submit" class="btn btn-success btn-outline">
                            ...
                            <span>{{ __('Ripristina livello') }}</span>
                        </button>
                    </form>
                @else
                    <form method="POST" action="{{ route('admin.job-levels.destroy', $level) }}" onsubmit="return confirm('{{ __('Sei sicuro di voler eliminare questo livello?') }}')">
                        @csrf
                        @method('DELETE')
