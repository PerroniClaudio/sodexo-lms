<x-layouts.admin>
    <div class="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 sm:p-6 lg:p-8">
        <x-page-header :title="__('Nuova categoria di lavoro')" />

        <div class="card border border-base-300 bg-base-100 shadow-sm">
            <div class="card-body gap-6">
                <form method="POST" action="{{ route('admin.job-categories.store') }}" class="flex flex-col gap-6">
                    @csrf
                    ...
                    <div class="flex justify-end gap-3">
                        <a href="{{ route('admin.job-categories.index') }}" class="btn btn-ghost">
                            {{ __('Cancel') }}
                        </a>
