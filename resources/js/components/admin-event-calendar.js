...
const calendarEl = document.getElementById('admin-event-calendar');
const dayEventsContainer = document.getElementById('admin-event-calendar-day-events');
const dayEventsTitle = document.getElementById('admin-event-calendar-day-events-title');
const dayEventsList = document.getElementById('admin-event-calendar-day-events-list');
...
async function bootstrapCalendar() {
  try {
    const response = await fetch(calendarEl.dataset.eventsUrl, {
      headers: {
