...
export function getModuleData(root) {
    return {
        ...
        dispenseStatusUrl: root.dataset.dispenseStatusUrl,
        dispenseCompleteUrl: root.dataset.dispenseCompleteUrl,
        dispenseRedirectUrl: root.dataset.dispenseRedirectUrl,
